...
/// and an mc-crypto-box encrypted payload, containing the FogTxOutRecord protobuf.
///
/// Note: This is a database and enclave interface type, and is not sent to the user.
/// TxOutSearchResult is the corresponding user-facing object
...
/// types to be treated as u64, but if that changes then we could use it in those types also.
